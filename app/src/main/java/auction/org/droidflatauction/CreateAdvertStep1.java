...
public class CreateAdvertStep1 extends AppCompatActivity
    ...
    ArrayAdapter<CharSequence> rent_spinner_adapter,size_of_property_adapter,type_of_property_adapter;
    @Override
    ...
    public void iHaveForRentSpinner(){
        sp_i_have_for_rent = (Spinner) findViewById(R.id.size_of_property_spinner);
        type_of_property_adapter = ArrayAdapter.createFromResource(this,R.array.i_have_for_rent_spinner_options,android.R.layout.simple_spinner_item);
        type_of_property_adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        sp_i_have_for_rent.setAdapter(type_of_property_adapter);
    ...
    public void typeOfPropertySpinner(){
        ...
        size_of_property_adapter = ArrayAdapter.createFromResource(this,R.array.type_of_property_spinner_options,android.R.layout.simple_spinner_item);
        size_of_property_adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        sp_type_of_property.setAdapter(size_of_property_adapter);
    ...
    public void sizeOfPropertySpinner(){
        sp_size_of_property = (Spinner) findViewById(R.id.i_have_for_rent_spinner);
