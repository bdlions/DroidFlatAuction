...
public class MessageShowAdapter extends BaseAdapter {
    ...
    private ArrayList<String>message_sender_list,message_time_list,message_text_list, imgList;


    public MessageShowAdapter(Context context, ArrayList<Integer> listId, ArrayList<String> imgList, ArrayList<String> message_sender_list,ArrayList<String> message_time_list,ArrayList<String> message_text_list) {
